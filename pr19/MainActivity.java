...
public class MainActivity extends Activity {
    ...
    public void onClickShowDetails(View view){
        ...
        @SuppressLint("Recycle") Cursor cursor = getContentResolver().query(Uri.parse("content://com.demo.user.provider/users"),null,null,null,null);
